...
abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Template
{
     ...
     */
    public function getPriceHtml($product, $displayMinimalPrice = false, $idSuffix='', $displayDetails = true)
    {
        return $this->_getPriceBlock($product->getTypeId())
            ...
            ->toHtml() . Mage::getBlockSingleton('Symmetrics_DisplayTaxInfo_Block_Tax')->getTaxInfo($product, $displayDetails);
    }
