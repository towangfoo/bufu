...
.PHONY: docker-prepare-app
docker-prepare-app: docker-init docker-up ## Prepare app requirements and dependencies
	docker exec -it $(PROJECT_NAME)_$(DEFAULT_CONTAINER)_1 /root/workspace/scripts/prepare-workspace.sh
